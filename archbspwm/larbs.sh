...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/bazeeel/baz-bspwm.git" && repobranch="master"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/bazeeel/larbs-bspwm/master/archbspwm/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to My Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Spectrwm Arch Linux desktop, which I use as my main machine.\\n\\n-Luke" 10 60
	}
